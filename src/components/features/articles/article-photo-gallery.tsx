...
export function ArticlePhotoGallery({ photos, title }: ArticlePhotoGalleryProps) {
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {photos.map((url, index) => (
          <button
            ...
            className="group relative block h-48 w-full overflow-hidden rounded-xl border border-zinc-200 bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
          ...
          {total > 1 && (
            <>
              <button
                ...
                className={cn(
                  "absolute left-2 top-1/2 z-10 -translate-y-1/2 rounded-full bg-black/40 p-2 text-white transition-colors hover:bg-black/60",
                  "focus:outline-none focus:ring-2 focus:ring-white sm:left-4 sm:p-3",
                )}
              >
              ...
              <button
                ...
                className={cn(
                  "absolute right-2 top-1/2 z-10 -translate-y-1/2 rounded-full bg-black/40 p-2 text-white transition-colors hover:bg-black/60",
                  "focus:outline-none focus:ring-2 focus:ring-white sm:right-4 sm:p-3",
                )}
              >
