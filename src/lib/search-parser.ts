...
const KEYWORD_MAP: Record<string, { categories?: string[]; tags?: string[] }> = {
  ...
  "достопримечательность": { categories: ["cat-15"] },
  "достопримечательности": { categories: ["cat-15"] },
  "памятник": { categories: ["cat-15"] },
  "музей": { categories: ["cat-15"] },
  "храм": { categories: ["cat-15"] },
  "развлечение": { categories: ["cat-16"] },
  "развлечения": { categories: ["cat-16"] },
  "аквапарк": { categories: ["cat-16"] },
  "кино": { categories: ["cat-16"] },
  "бар": { categories: ["cat-17"] },
  "бары": { categories: ["cat-17"] },
  "паб": { categories: ["cat-17"] },
  "клуб": { categories: ["cat-17"] },
  "школа": { categories: ["cat-18"] },
  "садик": { categories: ["cat-18"] },
  "детский сад": { categories: ["cat-18"] },
  "прачечная": { categories: ["cat-19"] },
  "стирка": { categories: ["cat-19"] },
  "химчистка": { categories: ["cat-19"] },
